...
import {
    ...
    LayersIcon, MapPin, Zap, Eye, Users, Mail
} from 'lucide-react';
...
const TABS = [
    ...
    { id: 'permissions', label: 'User Invites', icon: Users },
        ...
        <div className="space-y-6">
            <div className="p-4 rounded-xl bg-blue-500/5 border border-blue-500/20">
                ...
                <p className="text-xs text-slate-400 mb-6 leading-relaxed">
                    This action sends a secure Clerk invitation to the specified email address. 
                    The recipient will be granted <span className="text-blue-400 font-bold">Strategic Level Clearance</span> (City Admin) 
                    upon completing their registration.
                </p>

                <form onSubmit={handleInvite} className="space-y-4">
                    <div>
                        <label className="text-[10px] text-slate-500 uppercase tracking-widest block mb-2 font-bold">Target Email Address</label>
                        <div className="relative">
                            ...
                            <input
                                ...
                                placeholder="administrator@cityhall.gov.in"
                                required
                                className="w-full bg-slate-900 border border-white/10 rounded-xl pl-10 pr-4 py-3 text-sm text-white focus:outline-none focus:border-blue-500/50 transition-colors"
                            />
                        </div>
                    </div>
                    ...
                    <button
                        type="submit"
                        disabled={loading}
                        className="w-full bg-blue-600 hover:bg-blue-500 disabled:opacity-50 text-white font-bold py-3 rounded-xl transition-all shadow-[0_0_20px_rgba(37,99,235,0.3)] flex items-center justify-center gap-2"
                    >
                        {loading ? <RefreshCw className="w-4 h-4 animate-spin" /> : <Mail className="w-4 h-4" />}
                        {loading ? 'Transmitting Invitation...' : 'Dispatch Secure Invitation'}
                    </button>
                </form>
            ...
            <div className="grid grid-cols-2 gap-4">
                <div className="p-4 rounded-xl bg-white/[0.02] border border-white/5 font-mono">
                    <h5 className="text-[10px] text-slate-500 uppercase tracking-widest mb-2 font-black">Role Capabilities</h5>
                    <ul className="text-[10px] text-slate-400 space-y-1">
                        <li>· Modify Resource Allocation</li>
                        <li>· View Strategic Risk Trends</li>
                        <li>· Invite Ward-Level Officers</li>
                        <li>· Execute Mitigation Protocols</li>
                    </ul>
                </div>
                <div className="p-4 rounded-xl bg-white/[0.02] border border-white/5 font-mono">
                    <h5 className="text-[10px] text-slate-500 uppercase tracking-widest mb-2 font-black">Security Protocol</h5>
                    <p className="text-[10px] text-slate-400">
                        Invitations expire after 72 hours. Public registration for this role is strictly prohibited.
                    </p>
                </div>
            </div>
        </div>
